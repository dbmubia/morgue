...
public class MainForm extends JFrame implements WindowListener{
	...
	String DBSource = "jdbc:odbc:HMIS";
        String DBUserName = "kogie";
	String DBPassword = "26311273";
...
// 		}
	...
	public JMenuBar CreateJMenuBar(){
		...
		//End records menu
			...
			//-- For Customer
			JMenuItem ItmCustomer = new JMenuItem("Students");
...
//        ItmNewUser.setEnabled(User.UserRight(txtUserID.getText().trim(), "RPT-004",Data.typeOfAction.View));                               
	...
	protected JToolBar CreateJToolBar (){
		...
		NewJToolBar.add(CreateJToolbarButton("Add new corpse details","src/images/Add_new.png","toolCus"));
